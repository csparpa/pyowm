...
class Test(unittest.TestCase):
    ...
    def test_init_fails_when_reception_time_is_negative(self):
        self.assertRaises(ValueError, Observation, -123456, self.__test_location, self.__test_weather)
        
    def test_getters_return_expected_data(self):
        instance = Observation(self.__test_reception_time, self.__test_location, self.__test_weather)
    ...
    def test_XML_dump(self):
        ...
        """
        expectedOutput = """<Observation><reception_time>%s</reception_time>%s%s</Observation>""" % \
            (self.__test_reception_time, self.__test_location.to_XML(), self.__test_weather.to_XML())
        instance = Observation(self.__test_reception_time, self.__test_location, self.__test_weather)
