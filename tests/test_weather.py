...
class TestWeather(unittest.TestCase):
    ...
    def test_getters_return_expected_data(self):
        ...
        self.assertEqual(instance.get_reference_time(),
    ...
    def test_returning_different_formats_for_times(self):
        ...
        self.assertEqual(instance.get_reference_time(timeformat='iso'),
                         self.__test_iso_reference_time)
        self.assertEqual(instance.get_reference_time(timeformat='unix'),
                         self.__test_reference_time)
        self.assertEqual(instance.get_sunset_time(timeformat='iso'),
                         self.__test_iso_sunset_time)
        self.assertEqual(instance.get_sunset_time(timeformat='unix'),
                         self.__test_sunset_time)
        self.assertEqual(instance.get_sunrise_time(timeformat='iso'),
                         self.__test_iso_sunrise_time)
        self.assertEqual(instance.get_sunrise_time(timeformat='unix'),
    ...
    def test_time_related_methods_fai_with_unknown_time_formats(self):
        ...
        """
        instance = self.__test_instance
        self.assertRaises(ValueError, Weather.get_reference_time, instance,
                          'xyz')
