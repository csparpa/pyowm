...
class TestMetaImage(unittest.TestCase):
    ...
    test_instance = MetaImage('http://a.com', ImageTypeEnum.PNG, MetaImagePresetEnum.FALSE_COLOR,
                              SatelliteNameEnum.SENTINEL_2, test_acquisition_time, 98.2, 0.3, 11.7, 7.89)

    def test_init_fails_with_wrong_parameters(self):
        self.assertRaises(AssertionError, MetaImage, None, ImageTypeEnum.PNG, MetaImagePresetEnum.FALSE_COLOR,
                          SatelliteNameEnum.SENTINEL_2, self.test_acquisition_time, 98.2, 0.3, 11.7, 7.89)
        self.assertRaises(AssertionError, MetaImage, 'http://a.com', 'a_string', MetaImagePresetEnum.FALSE_COLOR,
                          SatelliteNameEnum.SENTINEL_2, self.test_acquisition_time, 98.2, 0.3, 11.7, 7.89)
        self.assertRaises(AssertionError, MetaImage, 'http://a.com', ImageTypeEnum.PNG, MetaImagePresetEnum.FALSE_COLOR,
