...
class TestOWM25(unittest.TestCase):
    ...
    def test_weather_at(self):
        ...
        OWMHTTPClient.call_API = self.mock_httputils_call_API_returning_single_obs
    ...
    def test_find_weather_by_name(self):
        ref_to_original_call_API = OWMHTTPClient.call_API
        OWMHTTPClient.call_API = self.mock_httputils_call_API_returning_multiple_obs
    ...
    def test_three_hours_forecast(self):
        ref_to_original_call_API = OWMHTTPClient.call_API
        OWMHTTPClient.call_API = self.mock_httputils_call_API_returning_3h_forecast
    ...
    def test_daily_forecast(self):
        ref_to_original_call_API = OWMHTTPClient.call_API
        OWMHTTPClient.call_API = self.mock_httputils_call_API_returning_daily_forecast
    ...
    def test_weather_history(self):
        ref_to_original_call_API = OWMHTTPClient.call_API
        OWMHTTPClient.call_API = self.mock_httputils_call_API_returning_city_weather_history
